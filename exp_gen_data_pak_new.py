...
def main():
    karachi_raster_path = "/netscratch/mukhtar/Archive/tmp/karachi.tif"
    karachi_mask_path = "/netscratch/mukhtar/ncode_slum_i_taha-main/karachi_data/karachi_ground_truth.tif"

    PAK_sat_paths = [(karachi_raster_path, karachi_mask_path)]
    splits_output_path = "/netscratch/mukhtar/ncode_slum_i_taha-main/karachi_data"
    ...
    create_super_splits_city("Karachi", splits_output_path, thresh_precent, train_val_percent, train_percent, random_seed, save=True)
